/**
  *
  * @file    apm32f4xx_dal_cfg_template.h
  * @brief   DAL configuration template file. 
  *          This file should be copied to the application folder and renamed
  *          to apm32f4xx_dal_cfg.h.
  *
  * @attention
  *
...
#define  USE_DAL_COMP_REGISTER_CALLBACKS        0U /* COMP register callback disabled      */
